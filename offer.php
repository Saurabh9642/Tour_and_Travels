                                            ...
                                            <div class="input-wrap">
                                                <div class="inside-wrap">
                                                    ...
                                                    <div class="from">
                                                        ...
                                                        <input class="input" type="" name="" value="Karad">
                                                    </div>
                                                    <div class="to">
                                                        <span class="inside-lable">To</span>
                                                        <input class="input" type="" name="" value="Mumbai">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <ul class="screen-home__rs-row">
                                        <li class="screen-home__rs-col">
                                            <div class="screen-homers-from-to">
                                                <span style="font-size: 18px;">Karad</span>
                                                <span class="screen-home__rs-arrow"></span>
                                                <span style="font-size: 18px;">Mumbai</span>
                                            </div>
                            ...
                            <div class="screen-bus__location-filter-row">
                                <div class="screen-bus__location">
                                    ...
                                    <div class="screen-bus__date-row">
                                        <span>Wed, 10/ 05/ 2023</span> - <span>Fri, 12/ 12/ 2023</span>
                                    </div>
                                </div>
                ...
                <section class="screen-bottom">
                    <div>
                        <ul>
                            <li>
                                <figure>
                                    <a href="file:///D:/BCA-3%20Project/website.html"><img src="https://i.ibb.co/n1kQzHj/home.png"></a>
                                </figure>
                            </li>
                            <li>
                                <figure>
                                    <a href="file:///D:/BCA-3%20Project/payment.html"><img src="https://i.ibb.co/sjXwWkz/tickets.png"></a>
                                </figure>
                            </li>
                            <li>
                                <figure>
